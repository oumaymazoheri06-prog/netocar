    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
                ...
                <flux:tooltip :content="__('Quick Guide')" position="bottom">
                    <flux:navbar.item
                        class="h-10 max-lg:hidden [&>div>svg]:size-5"
                        icon="book-open-text"
                        :href="route('guide')"
                        wire:navigate
                        :label="__('Quick Guide')"
                    />
                </flux:tooltip>
                <flux:tooltip :content="__('Billing Info')" position="bottom">
                    <flux:navbar.item
                        class="h-10 max-lg:hidden [&>div>svg]:size-5"
                        icon="banknotes"
                        :href="route('agency-billing.edit')"
                        wire:navigate
